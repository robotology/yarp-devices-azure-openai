...
namespace {
    YARP_LOG_COMPONENT(WhisperDeviceParamsCOMPONENT, "yarp.device.WhisperDevice")
}


WhisperDevice_ParamsParser::WhisperDevice_ParamsParser()
{
}


std::vector<std::string> WhisperDevice_ParamsParser::getListOfParams() const
{
...
bool WhisperDevice_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
...
std::string WhisperDevice_ParamsParser::getConfiguration() const
{
...
bool      WhisperDevice_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    //Check for --help option
    if (config.check("help"))
    {
        yCInfo(WhisperDeviceParamsCOMPONENT) << getDocumentationOfDeviceParams();
    }
    ...
    //Parser of parameter ENVS::end_point_name
    {
        ...
        if (sectionp.check("end_point_name"))
        {
            ...
            yCInfo(WhisperDeviceParamsCOMPONENT) << "Parameter 'ENVS::end_point_name' using value:" << m_ENVS_end_point_name;
        }
        else
        {
            yCInfo(WhisperDeviceParamsCOMPONENT) << "Parameter 'ENVS::end_point_name' using DEFAULT value:" << m_ENVS_end_point_name;
        }
    ...
    //Parser of parameter ENVS::deployment_id_name
    {
        ...
        if (sectionp.check("deployment_id_name"))
        {
            ...
            yCInfo(WhisperDeviceParamsCOMPONENT) << "Parameter 'ENVS::deployment_id_name' using value:" << m_ENVS_deployment_id_name;
        }
        else
        {
            yCInfo(WhisperDeviceParamsCOMPONENT) << "Parameter 'ENVS::deployment_id_name' using DEFAULT value:" << m_ENVS_deployment_id_name;
        }
    ...
    //Parser of parameter ENVS::api_key_name
    {
        ...
        if (sectionp.check("api_key_name"))
        {
            ...
            yCInfo(WhisperDeviceParamsCOMPONENT) << "Parameter 'ENVS::api_key_name' using value:" << m_ENVS_api_key_name;
        }
        else
        {
            yCInfo(WhisperDeviceParamsCOMPONENT) << "Parameter 'ENVS::api_key_name' using DEFAULT value:" << m_ENVS_api_key_name;
        }
    ...
    //Parser of parameter ENVS::api_version_name
    {
        ...
        if (sectionp.check("api_version_name"))
        {
            ...
            yCInfo(WhisperDeviceParamsCOMPONENT) << "Parameter 'ENVS::api_version_name' using value:" << m_ENVS_api_version_name;
        }
        else
        {
            yCInfo(WhisperDeviceParamsCOMPONENT) << "Parameter 'ENVS::api_version_name' using DEFAULT value:" << m_ENVS_api_version_name;
        }
    ...
    if (prop_check.size() > 0)
    {
        ...
        for (auto it=prop_check.begin(); it!=prop_check.end(); it++)
        {
            ...
            {
                yCError(WhisperDeviceParamsCOMPONENT) << "User asking for parameter: "<<it->name <<" which is unknown to this parser!";
                extra_params_found = true;
            }
            else
            {
                yCWarning(WhisperDeviceParamsCOMPONENT) << "User asking for parameter: "<< it->name <<" which is unknown to this parser!";
            }
        }
...
std::string      WhisperDevice_ParamsParser::getDocumentationOfDeviceParams() const
{
    std::string doc;
    doc = doc + std::string("\n=============================================\n");
    doc = doc + std::string("This is the help for device: WhisperDevice\n");
    doc = doc + std::string("\n");
    ...
    doc = doc + " yarpdev --device whisperDevice --ENVS::end_point_name AZURE_ENDPOINT --ENVS::deployment_id_name DEPLOYMENT_WHISPER_ID --ENVS::api_key_name AZURE_API_KEY --ENVS::api_version_name AZURE_API_VERSION_TTS\n";
    doc = doc + std::string("Using only mandatory params:\n");
    doc = doc + " yarpdev --device whisperDevice\n";
    doc = doc + std::string("=============================================\n\n");    return doc;
}
