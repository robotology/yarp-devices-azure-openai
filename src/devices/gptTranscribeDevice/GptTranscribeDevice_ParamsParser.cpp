...
namespace {
    YARP_LOG_COMPONENT(GptTranscribeDeviceParamsCOMPONENT, "yarp.device.GptTranscribeDevice")
}


GptTranscribeDevice_ParamsParser::GptTranscribeDevice_ParamsParser()
{
}


std::vector<std::string> GptTranscribeDevice_ParamsParser::getListOfParams() const
{
...
bool GptTranscribeDevice_ParamsParser::getParamValue(const std::string& paramName, std::string& paramValue) const
{
...
std::string GptTranscribeDevice_ParamsParser::getConfiguration() const
{
...
bool      GptTranscribeDevice_ParamsParser::parseParams(const yarp::os::Searchable & config)
{
    //Check for --help option
    if (config.check("help"))
    {
        yCInfo(GptTranscribeDeviceParamsCOMPONENT) << getDocumentationOfDeviceParams();
    }
    ...
    //Parser of parameter ENVS::end_point_name
    {
        ...
        if (sectionp.check("end_point_name"))
        {
            ...
            yCInfo(GptTranscribeDeviceParamsCOMPONENT) << "Parameter 'ENVS::end_point_name' using value:" << m_ENVS_end_point_name;
        }
        else
        {
            yCInfo(GptTranscribeDeviceParamsCOMPONENT) << "Parameter 'ENVS::end_point_name' using DEFAULT value:" << m_ENVS_end_point_name;
        }
    ...
    //Parser of parameter ENVS::deployment_id_name
    {
        ...
        if (sectionp.check("deployment_id_name"))
        {
            ...
            yCInfo(GptTranscribeDeviceParamsCOMPONENT) << "Parameter 'ENVS::deployment_id_name' using value:" << m_ENVS_deployment_id_name;
        }
        else
        {
            yCInfo(GptTranscribeDeviceParamsCOMPONENT) << "Parameter 'ENVS::deployment_id_name' using DEFAULT value:" << m_ENVS_deployment_id_name;
        }
    ...
    //Parser of parameter ENVS::api_key_name
    {
        ...
        if (sectionp.check("api_key_name"))
        {
            ...
            yCInfo(GptTranscribeDeviceParamsCOMPONENT) << "Parameter 'ENVS::api_key_name' using value:" << m_ENVS_api_key_name;
        }
        else
        {
            yCInfo(GptTranscribeDeviceParamsCOMPONENT) << "Parameter 'ENVS::api_key_name' using DEFAULT value:" << m_ENVS_api_key_name;
        }
    ...
    //Parser of parameter ENVS::api_version_name
    {
        ...
        if (sectionp.check("api_version_name"))
        {
            ...
            yCInfo(GptTranscribeDeviceParamsCOMPONENT) << "Parameter 'ENVS::api_version_name' using value:" << m_ENVS_api_version_name;
        }
        else
        {
            yCInfo(GptTranscribeDeviceParamsCOMPONENT) << "Parameter 'ENVS::api_version_name' using DEFAULT value:" << m_ENVS_api_version_name;
        }
    ...
    if (prop_check.size() > 0)
    {
        ...
        for (auto it=prop_check.begin(); it!=prop_check.end(); it++)
        {
            ...
            {
                yCError(GptTranscribeDeviceParamsCOMPONENT) << "User asking for parameter: "<<it->name <<" which is unknown to this parser!";
                extra_params_found = true;
            }
            else
            {
                yCWarning(GptTranscribeDeviceParamsCOMPONENT) << "User asking for parameter: "<< it->name <<" which is unknown to this parser!";
            }
        }
...
std::string      GptTranscribeDevice_ParamsParser::getDocumentationOfDeviceParams() const
{
    std::string doc;
    doc = doc + std::string("\n=============================================\n");
    doc = doc + std::string("This is the help for device: GptTranscribeDevice\n");
    doc = doc + std::string("\n");
    ...
    doc = doc + " yarpdev --device gptTranscribeDevice --ENVS::end_point_name AZURE_ENDPOINT --ENVS::deployment_id_name DEPLOYMENT_TRANSCRIBE_ID --ENVS::api_key_name AZURE_API_KEY --ENVS::api_version_name AZURE_API_VERSION_TRANSCRIBE\n";
    doc = doc + std::string("Using only mandatory params:\n");
    doc = doc + " yarpdev --device gptTranscribeDevice\n";
    doc = doc + std::string("=============================================\n\n");    return doc;
}
